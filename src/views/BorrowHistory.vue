    ...
    <div style="padding: 0px 0">
        ...
        ></el-input>
          <!--                0已借出 / 1已归还 / 2过期未还 / 3已预约-->
				<el-select
                v-model="searchParams.borrowStatus"
                placeholder="请选择借阅状态"
        >
                ...
                <el-table-column label="操作" width="200px">
                    <template #default="scope">
                        <el-button
                                type="primary"
                                size="mini"
                                @click="showBook(scope.row.bookId)"
                        ...
                        <el-button
                                type="primary"
                                size="mini"
                                @click="showUser(scope.row.userId)"
                        >用户信息
                        </el-button
                        >
                    </template>
        ...
        <div style="margin: 10px">
            ...
            <el-dialog title="图书信息" :visible.sync="bookVis" width="60%">
                ...
                <template #footer>
					<span class="dialog-footer">
						<el-button type="primary" @click="bookVis = false">确 定</el-button>
					</span>
                </template>
            </el-dialog>
            <!--用户信息窗口-->
            <el-dialog title="用户信息" :visible.sync="userVis" width="50%">
                ...
                <template #footer>
					<span class="dialog-footer">
						<el-button type="primary" @click="userVis = false">确 定</el-button>
					</span>
                </template>
            </el-dialog>
        </div>
